...
export default function HomeScene({ username, setUsername, handleConnect }: ConnectProps) {
  ...
  return <div className="flex flex-col items-center">
    <div className='flex flex-col items-center mb-4'>
      ...
      { Env.discordLink && Env.discordLink !== 'DISABLED' && <p><a className='inline font-bold hover:underline' href={Env.discordLink} target='_blank' rel='noreferrer'>
      ...
      { Env.paypalDonateLink && Env.paypalDonateLink !== 'DISABLED' && <p><a className='inline font-bold hover:underline' href={Env.paypalDonateLink} target='_blank' rel='noreferrer'>
  ...
  <div className='flex flex-col items-center mb-4'>
      <ul className='text-l font-bold text-center mb-2 text-red'>
        <br /><br />
      </ul>
      <ul className='text-l font-bold text-center mb-2 text-red'>
