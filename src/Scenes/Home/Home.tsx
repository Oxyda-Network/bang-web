...
export default function HomeScene({ username, setUsername, handleConnect }: ConnectProps) {
  ...
  return <div className="flex flex-col items-center">
    <div className='flex flex-col items-center mb-4'>
      ...
      { Env.paypalDonateLink && Env.discordLink !== 'DISABLED' && <p><a className='inline font-bold hover:underline' href={Env.paypalDonateLink} target='_blank' rel='noreferrer'>
  ...
  <div className='flex flex-col items-center mb-4'>
      <ul className='text-l font-bold text-center mb-2 text-red-500'>
        <br /><br />
      </ul>
      <ul className='text-l font-bold text-center mb-2 text-red-500'>
