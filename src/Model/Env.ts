...
const Env = (() => {
    ...
    const bangClientUrl = import.meta.env.VITE_BANG_CLIENT_URL as string | undefined;
    ...
    return { bangServerUrl, bangClientUrl, bangTrackingUrl, bangImageUrl, language, discordLink, paypalDonateLink } as const;
})();
